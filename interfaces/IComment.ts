...
export interface ICommentStorage extends ICommentBase {
  children?: Array<ICommentStorage>; // Objects of type IComment that are children to this comment.  This is a convenience property that is only used for the UI. It is not persisted.
