...
//
// class EventsBar extends React.Component<EventsBarProps> {
//   private touch: {
...
//
//   componentDidMount() {
//     const selectedEvent = this.props.events[this.props.index ?? 0];
//     selectedEvent &&
...
//
//     event?.distance && this.slideToPosition(-event.distance);
//   };
//
//   render() {
...
//     if (!this.props.index || !this.props.events[this.props.index]) {
